...
<div className="flex-1 overflow-y-auto p-4 flex flex-col justify-end mr-7">
    <p className="border-2 border-zinc-200 w-fit px-3 py-1 rounded-2xl bg-white mb-2 text-black">{lastMsg}</p>
    {messages.map((value,index)=>{
      return(<p className="border-2 border-zinc-200 w-fit px-3 py-1 rounded-2xl mb-2  bg-green-700 ml-auto" key={index}>{value}</p>)
    })}
