  ...
  return(
    <div>
      <nav className="flex gap-3 items-center bg-zinc-900">
        ...
        <div className="w-[65%] min-w-0 border-2" title="Group">
          <p>{name}</p>
      ...
      <div>
        ...
        <div className="flex items-center top_imgs">
          <img alt="error" src="https://unpkg.com/lucide-static/icons/plus.svg"/>
          <img alt="Error" src="https://unpkg.com/lucide-static/icons/smile.svg"  />
          <input type="text" className="border-2 " placeholder="Enter the text here"/>
          <img src="https://unpkg.com/lucide-static/icons/mic.svg"className="fixed [right:0]"/>
        </div>
      </div>
    </div>
  )
